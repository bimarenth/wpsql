...
PROJECT_NAME=Medicplus # Your project name. You can see it in the URL of the portal i.e. https://console.cloud.google.com/run?project=my-cr-project&folder=&organizationId= then the project is "my-cr-project"
...
CLOUDSQL_TIER=db-f1-micro # I'm using the smallest MySQL instance. A full list is available here: https://cloud.google.com/sql/pricing#2nd-gen-pricing
ROOT_PSWD=inipassword # Enter a root password of your choice. Something strong!
DB_USER=wpuser # You're welcome to change this if you like
USER_PSWD=inipassword # For the "wordpress" user, enter a password of your choice. Something strong!
REGION=asia-southeast2 # Feel free to set this to wahtever you like BUT be aware that, as of this writing, Cloud Run is not available everywhere. Full list of regions is here: https://cloud.google.com/compute/docs/regions-zones
ZONE=asia-southeast2-a # Once again, set it to whatever you like. See above link for the available zones
...
gcloud sql instances create $CLOUDSQL_INSTANCE --tier=$CLOUDSQL_TIER --region=asia-southeast2
...
# Using that
gcloud auth sql-test-bima@civic-gate-353504.iam.gserviceaccount.com 
